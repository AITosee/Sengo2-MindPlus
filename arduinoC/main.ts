...
namespace Sengo2 {
    ...
    export function Begin(parameter: any) {
        ...
        Generator.addObject(`sengo2.Object`, "Sengo2", `sengo2(${addr});`);
        ...
        Generator.addCode(`while (SENTRY_OK != sengo2.begin(&${mode})) {yield();}`);
    }
    ...
    export function SetParamNum(parameter: any) {
        ...
        Generator.addCode(`sengo2.SetParamNum(${vision_type},(int)${num});`);
    }
    ...
    export function SetColorParam(parameter: any) {
        ...
        Generator.addCode(`sengo2.SetParam(Sengo2::kVisionColor,&param,(int)${num});`);
    }
    ...
    export function SetBlobParam(parameter: any) {
        ...
        Generator.addCode(`sengo2.SetParam(Sengo2::kVisionBlob,&param,(int)${num});`);
    }
    ...
    export function SetMaxBlobParam(parameter: any) {
        let mode = parameter.MODE.code;
        Generator.addCode(`sengo2.VisionSetMode(Sengo2::kVisionBlob,  ${mode});`);
    }
    ...
    export function SetMaxAprilTagParam(parameter: any) {
        let mode = parameter.MODE.code;
        Generator.addCode(`sengo2.VisionSetMode(Sengo2::kVisionAprilTag,  ${mode});`);
    }
    ...
    export function SetMaxLineParam(parameter: any) {
        let mode = parameter.MODE.code;
        Generator.addCode(`sengo2.VisionSetMode(Sengo2::kVisionLine,  ${mode});`);
    }
    ...
    export function SetOperaParam(parameter: any) {
        ...
        Generator.addObject("param_obj", "sentry_object_t", `param;`);
        Generator.addCode(`param.label = ${l};`);
        Generator.addCode(`sengo2.SetParam(${vision_type},&param,(int)${num});`);
    }
    ...
    export function GetVisionResult(parameter: any) {
        ...
        let vision_type = parameter.VISION_TYPE.code;
        Generator.addCode([`sengo2.GetValue(${vision_type}, kStatus)`, Generator.ORDER_UNARY_POSTFIX]);
    }
    ...
    export function GetColorValue(parameter: any) {
        ...
        Generator.addCode([`sengo2.GetValue(Sengo2::kVisionColor,${obj},(int)${num})`, Generator.ORDER_UNARY_POSTFIX]);
    }
    ...
    export function GetValue(parameter: any) {
        ...
        let num = parameter.NUM.code;
        let obj = parameter.OBJ_INFO.code;
        Generator.addCode([`sengo2.GetValue(${vision_type},${obj},(int)${num})`, Generator.ORDER_UNARY_POSTFIX]);
    }
    ...
    export function GetLineValue(parameter: any) {
        ...
        let num = parameter.NUM.code;
        let obj = parameter.OBJ_INFO.code;
        Generator.addCode([`sengo2.GetValue(Sengo2::kVisionLine,${obj},(int)${num})`, Generator.ORDER_UNARY_POSTFIX]);
    }
    ...
    export function GetQrCodeValue(parameter: any) {
        ...
        let num = parameter.NUM.code;
        let obj = parameter.OBJ_INFO.code;
        Generator.addCode([`sengo2.GetValue(Sengo2::kVisionQrCode,${obj},(int)${num})`, Generator.ORDER_UNARY_POSTFIX]);
    }
    ...
    export function GetColorLable(parameter: any) {
        ...
        Generator.addCode([`sengo2.GetValue(Sengo2::kVisionColor,kLabel,(int)${num})==${obj}`, Generator.ORDER_UNARY_POSTFIX]);
    }
    ...
    export function GetColorBlob(parameter: any) {
        ...
        let num = parameter.NUM.code;
        let obj = parameter.COLOR_LABLE.code;
        Generator.addCode([`sengo2.GetValue(Sengo2::kVisionBlob,kLabel,(int)${num})==${obj}`, Generator.ORDER_UNARY_POSTFIX]);
    }
    ...
    export function GetCardLable(parameter: any) {
        ...
        Generator.addCode([`sengo2.GetValue(Sengo2::kVisionCard,kLabel,(int)${num})==${obj}`, Generator.ORDER_UNARY_POSTFIX]);
    }
    ...
    export function GetClass20Lable(parameter: any) {
        ...
        Generator.addCode([`sengo2.GetValue(Sengo2::kVision20Classes,kLabel,(int)${num})==${obj}`, Generator.ORDER_UNARY_POSTFIX]);
    }
}
